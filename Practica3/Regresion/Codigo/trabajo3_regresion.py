...
model = Ridge()
parametros = {'alpha': [1, 0.1, 0.01, 0.001, 0.0001], 'solver': ['svd']}
...
model = SGDRegressor()
parametros = {'loss': ['squared_loss'], 'penalty': ['l1', 'l2'], 'alpha': [1, 0.1, 0.01, 0.001, 0.0001]
